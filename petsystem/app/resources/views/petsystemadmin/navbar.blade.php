...
<nav class="main-header navbar navbar-expand navbar-white navbar-light sidebar-closed">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block ">
      <a href="/EMRS_home" class="nav-link">首頁</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown user-menu">
      <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        ...
        <span class="d-none d-md-inline">Petemers動物醫院 - {{ Auth::user()->name }}</span>
      </a>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-closed">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="/EMRS_home" class="d-block">{{ Auth::user()->name }} 首頁</a>
      </div>
    </div>
    <!-- Sidebar Menu -->
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="/admincheckappointment" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>掛號系統</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="/admincheckmedicalrecord" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>病歷系統</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="/showposts" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>醫院留言板</p>
          </a>
        </li>
