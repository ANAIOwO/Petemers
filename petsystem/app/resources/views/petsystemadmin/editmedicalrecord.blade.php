  ...
  <div class="card-body">
    ...
    <form method="post" action="{{ route('medicalrecords.update',$medicalrecord->id) }}">
      ...
      <div class="form-group">
        ...
        <input type=" text" class="form-control" name="medicalrecordnumber" value="{{ $medicalrecord->medicalrecordnumber }}"/>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type=" text" class="form-control" name="chipnumber" value="{{ $medicalrecord->chipnumber }}" />
      </div>
      <div class="form-group">
