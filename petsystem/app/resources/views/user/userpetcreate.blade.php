...
<body>
  ...
  <div class="card-body">
    ...
    <div class="rectangle">
      ...
      @endif
      <form name="myForm" class="myForm" method="post" action="{{ route('userpets.store') }}" accept-charset="utf-8" enctype="multipart/form-data">
        @csrf
        <br>
        <p>寵物照片:</p>
        ...
        <p>晶片號碼:</p>
        <input type="text" class="form-control col-in-s" id="inputMRnmb1" name="chipnumber" placeholder="" >
        <p>寵物生日:</p>
        <!--要寫一個填寫生日後會出現年紀的box-->
